      ...
      <main className="w-full h-full">
        <div className="bg-[url('/home.jpg')] bg-no-repeat  bg-cover w-full min-h-screen  flex items-center justify-center md:block">
          <div className="min-h-screen w-full flex bg-[#034f20]/15 md:p-30 pt-[20%]">
            ...
            <h1 className="text-[#034f20] md:text-4xl text-lg md:pb-10 pb-4 pt-2"><strong><i>Christmas is for Celebration</i></strong></h1>
            <p className="text-[#034f20] md:text-lg text-sm overflow-auto"> We believe that Christmas is a time for families to come together; a special season best spent creating memories
